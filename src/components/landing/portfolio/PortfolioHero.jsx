...
export default function PortfolioHero({ reducedMotion = false }) {
  return (
    <header className="relative min-h-[92svh] overflow-hidden bg-[#081009] text-white">
      ...
      />
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(8,16,9,0.88),rgba(8,16,9,0.28)_52%,rgba(8,16,9,0.72)),linear-gradient(180deg,rgba(8,16,9,0.4),rgba(8,16,9,0.05)_42%,rgba(8,16,9,0.88))]" />
      ...
      >
        <div className="max-w-5xl">
          ...
          <h1 className="font-heading text-[clamp(3.7rem,8.2vw,9rem)] font-medium leading-[0.88] text-white [text-wrap:balance]">
            Projetos que revelam a natureza da arquitetura
          </h1>
          <p className="mt-7 max-w-2xl text-base font-light leading-8 text-white/76 md:text-lg">
            Um acervo editorial de estudos, implantações e espaços externos criados para
            transformar chegada, permanência e estilo de vida.
          </p>
        ...
        <aside className="hidden border-l border-white/18 pl-7 text-white/68 lg:block">
          ...
          <p className="mt-5 text-lg font-light leading-8">
            Cada projeto é apresentado como uma decisão de atmosfera, técnica e uso:
            onde a vegetação valoriza a arquitetura sem competir com ela.
          </p>
